...
{
	message_ = message;
	std::cout << "Observer " << this->number_ << " triggered with new message from subject: " << this->message_ << std::endl;
	...
	// [TO DO]: method to analyse file content or generate custom report
